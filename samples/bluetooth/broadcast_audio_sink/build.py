...
def __main():
    ...
    build_cmd_net = f"west build {HCI_RPMSG_FOLDER} -b {NRF5340_AUDIO_DK_NET_NAME} --build-dir {BUILD_FOLDER_NET} -- -DOVERLAY_CONFIG=nrf5340_cpunet_iso_receive-bt_ll_sw_split.conf"
